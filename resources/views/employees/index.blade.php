              ...
              <div class="col">
                <div class="container" style="margin-top: 20px;">
                  <form id="DeleteBtn" action="{{ route('employees.destroy', ['id' => $emp->id]) }}" method="POST">
                    <input type="button" value="delete" class="btn btn-outline-danger" onclick="return confirm('Are you sure, You want to delete {{$emp->name}}\'s data?')">{{ method_field('DELETE') }} {!! csrf_field() !!}
